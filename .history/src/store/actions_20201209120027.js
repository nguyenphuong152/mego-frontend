...
export const getListProductWithPrice=({ commit }) => {
 ...
 export const getListProductFilter=({commit},{colectionId,brandId,modelId})=>{
    axios.get(`https://mego-backend.herokuapp.com/api/guest/collection/products`,{params:{collection_id:colectionId,brand_id:brandId,model_di:modelId}}).then(response=>{
