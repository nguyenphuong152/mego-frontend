    ...
    <v-row class="d-flex align-baseline">
      ...
      <v-col cols="2" class="d-flex justify-end">
        ...
        >
          ...
          <v-list class="text-start nav" :key="rerender">
            <v-list-item
            ...
            <v-list-item v-if="getUser.name != undefined" @click="logout()">
...
export default {
  ...
  computed: {
    getUser() {
      console.log("hiiiiiiiiii", sJSON.stringify(this.$store.getters.getUser));
