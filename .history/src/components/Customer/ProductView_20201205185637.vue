  ...
  <v-row>
    ...
    >
      <v-card
        ...
        max-height="400"
        outlined
        @click="goDetail(product.name,product.product_detail.price,product.id)"
      >
        <v-img
...
export default {
  ...
  methods: {
    goDetail: function (productName,productPrice, id) {
      this.$router.push({ name: "ProductDetail", params: { productName,productPrice, id }, });
    },
  },
};
</script>
