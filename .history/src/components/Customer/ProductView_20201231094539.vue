  ...
  <v-row>
    ...
    >
      <v-card class="mx-autoS" width="300" height="300" outlined>
        <v-img
          v-if="product.product_detail_min_price.id <= 15"
          :src="
            `https://mego-backend.herokuapp.com/api/image/product/${
              product.product_detail_min_price.id
            } ? 
            https://mego-backend.herokuapp.com/api/image/product/${Math.floor(
              Math.random() * 16
            )} `
          "
          :lazy-src="
            `https://mego-backend.herokuapp.com/api/image/product/${product.product_detail_min_price.id}`
          "
          aspect-ratio="1"
